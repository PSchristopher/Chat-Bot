  ...
  return (
    <>
      <div className="flex flex-col h-screen bg-white">
        {/* Header */}
        <div className="px-3 py-1 bg-opacity-40 border-b-[1px] border-[#cccccc]">
        ...
        {/* Footer */}
        <div className="flex flex-row justify-between items-center border-t-[1px] border-[#cccccc] min-h-[58px] h-auto">
          <div className="flex justify-center flex-1 px-3 h-auto">
            <textarea
              ref={inputRef}
              className="w-full px-3 bg-transparent text-[#000000] focus:outline-none resize-none h-auto pt-2 place p-1 "
              value={newQuestion}
              onChange={handleInputChange} // Changed the type of event handler
              placeholder="Type your message..."
              onKeyDown={handleKeyDown}
              maxLength={300}
              style={{ overflowY: 'scroll', scrollbarWidth: 'none' }} // Add scrollbarWidth: 'none' to hide the scrollbar
            />
          </div>
